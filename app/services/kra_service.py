...
def parse_kra_csv(file: UploadFile) -> SalesUploadResponse:
    """
    Parses a KRA sales CSV file, performs schema and type normalization,
    ...
    # Map headers to schema fields using kra_header_mapping
    mapping = settings.kra_header_mapping
    field_to_index = {}
    ...
    for row_idx, row in enumerate(reader, start=2):
        ...
        try:
            normalized = normalize_invoice_data(
                pin=row_values["pin"],
                customer_name=row_values["customer_name"],
            ...
            elif "customer name" in msg_lower:
                col_name = headers[field_to_index["customer_name"]]
